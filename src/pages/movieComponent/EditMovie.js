...
class EditMovie extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { ageRating, desc, director, duration, genre, onShowing, ratingIMDB, releaseDate, releaseYear, stars, title, url } = this.state;
      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h4><Link to={`/showMovie/${this.state.key}`} class="btn btn-primary">Movie List</Link></h4>
            <form onSubmit={this.onSubmit}>
              ...
              <div className="upload-data">
                ...
                <img height="300" width="200" src={this.state.url}></img>
              </div>
              <div class="form-group">
