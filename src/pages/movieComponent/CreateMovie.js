...
class CreateMovie extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { ageRating, desc, director, duration, genre, onShowing, ratingIMDB, releaseDate, releaseYear, stars, title, url, image } = this.state;
  ...
  render() {
    const { ageRating, desc, director, duration, genre, onShowing, ratingIMDB, releaseDate, releaseYear, stars, title, url, iamge } = this.state;
    return (
      <div class="container">
          ...
          <div class="panel-body">
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div className="upload-data">
                ...
                <img height="300" width="200" src={url}></img>
              </div>
              <div class="form-group">
