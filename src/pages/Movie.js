...
class Movie extends Component {
  ...
  onCollectionUpdate = (querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      const { ageRating, desc, director, duration, genre, onShowing, ratingIMDB, releaseDate, releaseYear, stars, title, url } = doc.data();
      movie.push({
        key: doc.id,
              ...
              <tbody>
                {this.state.movie.map(movie =>
                  <tr>
                    ...
                    <td><img src={movie.url} width="80px" height="110px" alt=""></img> </td>
